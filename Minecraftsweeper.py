...
from GameLogic.Game import Game, Minefield
...
FLAG = tex_coords((3, 1), (3, 1), (3, 1))
BOMB = tex_coords((2, 0), (2, 0), (2, 0))

BLOCK_1 =  tex_coords((0, 3), (0, 3), (0, 3))
BLOCK_2 =  tex_coords((1, 3), (1, 3), (1, 3))
BLOCK_3 =  tex_coords((2, 3), (2, 3), (2, 3))
BLOCK_4 =  tex_coords((3, 3), (3, 3), (3, 3))
BLOCK_5 =  tex_coords((0, 2), (0, 2), (0, 2))
BLOCK_6 =  tex_coords((1, 2), (1, 2), (1, 2))
BLOCK_7 =  tex_coords((2, 2), (2, 2), (2, 2))
BLOCK_8 =  tex_coords((3, 2), (3, 2), (3, 2))

VAL_BLOCKS = [BOMB, MINECOVER, BLOCK_1, BLOCK_2, BLOCK_3, BLOCK_4, BLOCK_5, BLOCK_6, BLOCK_7, BLOCK_8]
...
def position_to_array_coords(n, position):
...
class Model(object):
    ...
    def _initialize(self):
        """ Initialize the minefield board by placing blocks.
        """
        global game
        minefield = game.minefield

        # set the size of the minefield game board
        n = int( minefield.field_size / 2 )
        s = 1  # step size
